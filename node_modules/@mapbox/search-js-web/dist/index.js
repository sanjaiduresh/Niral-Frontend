...
<template>
  <div class="SearchBox">
    ...
    <div class="ActionIcon">
      <button aria-label="Clear" class="ClearBtn" type="button">${ht}</button>
...
</svg>`;var mt="1.0.0-beta.22";var vr=`https://api.mapbox.com/search-js/v${mt}/img/style-toggle-satellite.jpg`,br=`https://api.mapbox.com/search-js/v${mt}/img/style-toggle-default.jpg`,xr=768-1,Er=`@media only screen and (max-width: ${xr}px)`,Oo={variables:{unit:["mobile","16px","14px"],unitHeader:["mobile","24px","18px"],minWidth:"min(300px, 100vw)",spacing:"0.75em",padding:"0.5em 0.75em",paddingFooterLabel:"0.5em 0.75em",paddingModal:"1.25em",colorText:"rgba(0, 0, 0, 0.75)",colorPrimary:"#4264FB",colorSecondary:"#667F91",colorBackground:"#fff",colorBackgroundHover:"#f5f5f5",colorBackgroundActive:"#f0f0f0",colorBackdrop:"rgba(102, 127, 145, 0.3)",border:"none",borderRadius:"4px",boxShadow:`
...
`),yt,_,ye,Lt,Le=class extends k{constructor(){super(...arguments);n(this,yt,!1);n(this,_,void 0);n(this,ye,void 0);n(this,Lt,{})}get template(){return wr}get templateStyle(){return O}get templateUserStyle(){return A(".MapboxAddressConfirmation",this.theme)}get theme(){return t(this,Lt)}set theme(e){if(d(this,Lt,e),!t(this,_)||!e)return;this.updateTemplateUserStyle(A(".MapboxAddressConfirmation",e));let{ContentFeature:i,ContentNoFeature:o}=t(this,_);i.theme=e,o.theme=e}connectedCallback(){super.connectedCallback(),d(this,_,H(this,{MapboxAddressConfirmation:".MapboxAddressConfirmation",ContentFeature:".ContentFeature",ContentNoFeature:".ContentNoFeature"}));let{MapboxAddressConfirmation:e}=t(this,_);e.setAttribute("aria-hidden","true");let i=this.theme;if(i){let{ContentFeature:o,ContentNoFeature:r}=t(this,_);o.theme=i,r.theme=i}}disconnectedCallback(){d(this,ye,null)}hide(){var i;if(d(this,yt,!1),!t(this,_))return;let{MapboxAddressConfirmation:e}=t(this,_);e.setAttribute("aria-hidden","true"),(i=t(this,ye))==null||i.deactivate(),Do.default.off()}show(e,i,o){return P(this,null,function*(){var T;if(!t(this,_))return{type:"cancel"};let{MapboxAddressConfirmation:r,ContentFeature:a,ContentNoFeature:l}=t(this,_),{accessToken:c,minimap:u=!1,theme:p,footer:E}=i;this.theme=p,o?(a.removeAttribute("aria-hidden"),l.setAttribute("aria-hidden","true"),a.minimap=u,a.accessToken=c,a.footer=E,a.update(o,e)):(a.setAttribute("aria-hidden","true"),l.removeAttribute("aria-hidden"),l.update(e)),d(this,yt,!0),r.removeAttribute("aria-hidden"),Do.default.on();let C=o?a:l;return d(this,ye,(0,Rs.createFocusTrap)(r,{fallbackFocus:C,escapeDeactivates:()=>(this.hide(),!0)})),(T=t(this,ye))==null||T.activate(),new Promise(Vi=>{let U=C,F=be=>{U.removeEventListener("result",F);let qo=be.detail;this.hide(),Vi(qo==="change"?{type:"change",feature:o}:{type:qo})};U.addEventListener("result",F)})})}tryShow(e,i){return P(this,null,function*(){if(!t(this,_))return{type:"cancel"};let{accessToken:o,options:r={}}=i,a=new lo.ValidationCore(h({accessToken:o},r)),l=ze(e),u=(yield a.validate(l,{sessionToken:x.autofillSessionToken})).features[0];if(u){let p=C=>C.properties.match_code.confidence===lo.MatchCodeConfidence.exact,{skipConfirmModal:E=p}=i;if(E(u))return{type:"nochange"}}return yield this.show(e,i,u)})}};yt=new WeakMap,_=new WeakMap,ye=new WeakMap,Lt=new WeakMap;window.MapboxAddressConfirmation=Le;window.customElements.get("mapbox-address-confirmation")||customElements.define("mapbox-address-confirmation",Le);var jo=new Le;function co(i){return P(this,arguments,function*(s,e={}){var u;let{sections:o=[]}=e;jo.parentNode||document.body.appendChild(jo);let r={type:"nochange"},a=Mt(s),l=St(s),c=Array.from(document.querySelectorAll("mapbox-search-listbox"));for(let p of a){if(o.length){let F=l.find(be=>be.input===p);if(!F||!o.includes(F.section))continue}let E=ro(s,p),C=c.find(F=>F.input===p),T=C==null?void 0:C.autofillHost;if(T){let F=T.retrieveFeature;if(F){let be=Is(F);if(!Bs(E,be))continue}}let Vi=e.accessToken||x.accessToken,U=yield jo.tryShow(E,j(h({},e),{accessToken:Vi}));if(U.type==="change"){let F=Te(s,p);if(((u=F["address-line2"])==null?void 0:u.value)&&(U.feature.properties.address_line2=F["address-line2"].value),C)T.simulateRetrieve(U.feature);else{p.dataset.mapboxSuccess="true";let be=(0,Fs.featureToSuggestion)(U.feature);_o(s,p,be)}}U.type==="change"&&r.type!=="cancel"&&(r=U),U.type==="cancel"&&(r=U)}return r})}function uo(s,e,i,o,r){if(e){let a=M(`
        <span>
          <span></span>
          <br />
          <span></span>
        </span>
      `),[l,c]=Array.from(a.querySelectorAll("span > span"));if(i&&o)l.textContent=i,c.textContent=o;else{let u=e.split(",");l.textContent=u[0].trim(),c.textContent=u.slice(1).join(",").trim()}if(!r){if(s["address-line2"]){let u=document.createElement("span");u.textContent=s["address-line2"],a.insertBefore(u,c),a.insertBefore(document.createElement("br"),c)}if(s["address-line3"]){let u=document.createElement("span");u.textContent=s["address-line3"],a.insertBefore(u,c),a.insertBefore(document.createElement("br"),c)}}return a}else{let a=s["street-address"]||s["address-line1"]||"",l=s["address-line2"],c=s["address-line3"],u=[s["address-level4"]||"",s["address-level3"]||"",s["address-level2"]||"",`${s["address-level1"]||""} ${s["postal-code"]||""}`,s.country||s["country-name"]||""].filter(Boolean).join(", "),E=[a,l,c,u].filter(Boolean).map(T=>`<span>${T}</span>`).join("<br />");return M(`
        <span>${E}</span>
      `)}}function po(s,e,i,o){return P(this,null,function*(){if(!i)return;let r=Po(s),a=Object.values(Te(r,s));if(!e.detail.elements.some(T=>a.includes(T)))return;let l=St(r),u=l.find(T=>T.input===s).section,p=Array.from(new Set(l.filter(T=>e.detail.elements.includes(T.input)).map(T=>T.section)));if(!p.includes(u))return;let E=typeof i=="object"&&i.sections||[];if(E.length&&!E.some(T=>p.includes(T)))return;let C=typeof i=="object"?i:{};C=j(h({},C),{accessToken:o,sections:[u]}),yield co(r,C)})}var Ir="https://contribute-api.mapbox.com/v1",Br="https://contribute-api-staging.tilestream.net/v1",Hr="edit-suggestion";function ho(s,e){if(!x.feedbackEnabled)return;let i=window.location.hostname,r=`${ps(i)||hs(i)?Br:Ir}/${Hr}/address?access_token=${s}`,{originalCoordinate:a,originalAddress:l,changes:c}=e,u={action:"update",reason:"incorrect_address",location:{longitude:a[0],latitude:a[1]},userEmail:"no-reply-autofill@mapbox.com",changes:c,placeName:l};fetch(r,{method:"POST",headers:new Headers({"User-Agent":`mapbox-search-js.${mt}.${navigator.userAgent}`,"Content-Type":"application/json"}),body:JSON.stringify(u)})}var Or=M(`
<template>
